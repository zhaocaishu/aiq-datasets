...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-data_dir", required=True, type=str, help="Directory of the files"
    )
    ...
    stock_files = glob.glob(
        os.path.join(os.path.join(args.data_dir, "features"), "*.csv")
    )
    for stock_file in stock_files:
        ...
        trading_days = get_trading_calendar(args.data_dir, start_date, end_date)
