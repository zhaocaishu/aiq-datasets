...
# 股票均价表名
QUOTATION_VWAP_TABLE_NAME = "ts_quotation_vwap_daily"

# 股票均价表DDL
QUOTATION_VWAP_TABLE_DDL = """
CREATE TABLE ts_quotation_vwap_daily (
  ts_code varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '股票代码',
  trade_date varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '交易日期',
  vwap float DEFAULT NULL COMMENT '平均价',
  UNIQUE KEY uni_ts_code_trade_date (ts_code,trade_date)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='股票平均价格'
"""
